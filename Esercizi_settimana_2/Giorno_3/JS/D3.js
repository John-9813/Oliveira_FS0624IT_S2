...
const eyeColor = {
  ...
  brown: [],
  red: [],
  blue_gray: [],  /* blue_gray doveva venir trasformato in stringa per corrispondere correttamente ai dati forniti */
};
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  switch (character.eye_color) {
    ...
    case "red":
      ...
      break;
    case "blue-gray":
      eyeColor.blue_gray.push(character);  /*in caso blue_gray fosse stato la stringa 'blue-gray' per leggerlo usa le parentesi quadre [] */
      break;
    default:
      break;
  }
...
let crewMass = 0;
let m = 0; /* meglio chiamarli con "i" perchè sta per "index" o "indice" quindi meglio leggerlo così */
